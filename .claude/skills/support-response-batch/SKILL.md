...
| **K. 100%-AI creator lies about being real** — a **fully synthetic** account (no real person behind it) explicitly claims to be real when a fan asks directly, e.g. *"yes I am real, no I only use AI to edit"* | **REFUND** the purchase(s) made around/after that claim — verify in fadmin exactly what was said and when, never on the fan's paraphrase alone. **Narrow:** a creator who is AI-edited/deepfaked but has a **real person** behind the account is telling the truth if they say the same words — that stays **Ground A (NO REFUND)**. Check on the creator's profile / fadmin which kind of "AI" applies before refunding. *Interim clarification from Vincenzo, 2026-08-22 — narrower than a full policy rewrite; more detail expected once Fadmin/wallet top-ups are sorted, with a full team training pass to follow. Re-check for updates.* |
