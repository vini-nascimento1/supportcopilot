...
- **Never ask a creator to confirm their KYC is verified in a payout context.** Identity/KYC verification is a prerequisite to operating as a creator and earning — a creator who has a balance and is asking about a payout has already passed it. Confirm KYC status yourself in Fadmin; don't pose "is your KYC verified?" to the customer, and don't present "KYC not verified" as a likely reason an earning creator can't withdraw. KYC is payout-relevant only for **name/identity MATCH** on the destination (bank name = KYC name) or **business-doc completeness** (Articles of Incorporation), not as an are-you-verified gate.
- **Don't ask the customer to "confirm" details they already gave you.** If their message already states the transaction date, amount, handle, etc., use it — don't loop back with "please confirm X" just to feel thorough. That's a stalling move that delays an answer you could already give. Only ask for something genuinely missing or ambiguous. And if the real question has a generic, always-true answer (e.g. "why did my balance go negative after a chargeback" — chargebacks always debit available balance, not pending, regardless of the specific account), answer it directly; don't gate a universal mechanism explanation behind an account-specific confirmation step.
...
| Ground | Outcome |
| --- | --- |
| **A. Buyer's remorse** — changed mind, forgot to cancel, auto-charged after a free trial, "didn't like it", content already accessed in a sub, "creator is AI" (AI tag visible), creator just slow/not replying, **fan was blocked by the creator after subscribing/paying** (blocking is the creator's prerogative — the fan had access during the period they paid for; being blocked afterward is not non-delivery or a service failure), deal made or moved off-platform (e.g. Telegram) — **applies even to "wrong item delivered" complaints if the deal itself was arranged off-platform**. See **Ground K** below for the one narrow exception to the "creator is AI" clause. | **NO REFUND** |
...
| **C. Unauthorised / fraudulent charge** | 3DS **completed** → **NO REFUND**. 3DS **NOT** completed / suspicious → **ESCALATE to Fraud Issues** (don't refund yourself — Fraud Issues confirms and processes the refund themselves). |
| **D. Creator banned (compliance)** | Refund the **ACTIVE subscription ONLY**. Past periods + one-time tips/messages → **NO REFUND**. |
| **D.1 Creator banned by automated/unreviewed system flag** (e.g. Fadmin ban reason `SYS_RAV`, no admin note, no human review yet) | **Same as D — refund the subscription only, nothing else, no exception.** Confirmed by Vincenzo 2026-08-18: don't escalate to Ground J just because the fan's spend pattern *looks* like a scam (e.g. escalating PPV message prices right before the ban). The rationale is Ground D's own logic taken literally: **access was delivered at the moment of purchase, regardless of how much the fan actually used it, or whether the creator later turns out to be running a scam.** Messages/PPV/tips stay non-refundable regardless. And this is a **bulk action, not a per-ticket one** — once a creator is confirmed banned, refund the subscription for **every one of that creator's fans**, not just the person who happened to complain. |
...
| **J. Possible scam by creator, including emotional blackmail** (money for "hospital bills", promised meetups, emotional manipulation/blackmail) | **INVESTIGATE**: screenshots + verify in fadmin yourself. This is a **cooling-off case, not a same-day call** — get **explicit confirmation from Moderation** (not just any second opinion) before refunding. Once Moderation confirms, refund all payments, strike the creator, disable payouts until they reach out. |
| **K. Fully-AI creator answers a direct "are you AI?" question misleadingly** — a **100% AI-generated** account (no real person behind it) replies *"I only use AI to enhance my content"*, *"I am real"*, *"I just use Photoshop"* instead of disclosing clearly | **SPLIT ON THE TIMESTAMP OF THAT REPLY.** Purchases **before** it → **NO REFUND** (subs, PPVs, tips alike — we assume the fan saw the AI tag). Purchases **after** it → **REFUND** the eligible ones; from that point it's a misleading/deceptive practice. Pull the creator's actual message and its time in fadmin — never the fan's paraphrase. Reply to the fan with the **"AI Refund Claim"** macro confirming the AI tag is present. **Narrow:** an AI-edited creator with a **real person** behind the account is telling the truth saying the same words → stays **Ground A (NO REFUND)**; confirm which kind of AI account it is first. See the agent-only enforcement note below. *Vincenzo, 2026-09-12 (Slack policy update + September refresher) — supersedes the 2026-08-22 interim wording, and supersedes "it doesn't matter what the creator said".* |

**If unsure which ground applies, or the case doesn't clearly match any leaf** → ask a leader/manager rather than guessing. Don't invent a resolution.

**Before any refund leaf (mandatory checks):** confirm the fan raised **within 30 days**; verify in **fadmin yourself** that the claim matches (delivered content / the agreement / ban timing / the actual charge); require screenshots for not-as-described; check 3DS for unauthorised charges; separate active sub vs past periods/tips for banned creators; a tip runs through the same ground-matching as any other payment (see below) — it isn't specially excluded.
...
**Tips and PPV — corrected 2026-08-22, corrected again 2026-08-31:** tips are **not** categorically non-refundable. Earlier guidance in this skill saying "a tip is a tip, never refunded" was wrong. A tip runs through the **same Q2 tree** as any other payment: Ground B if paid for something specific that wasn't delivered/not as described, Ground J if paid under a scam or emotional-blackmail claim, Ground K if paid to a 100%-AI account that lied about being real, and so on. If no ground matches, it's Ground A — **NO REFUND**, same default as any other payment; we remain **no-refund-first**, this isn't a blanket "tips are always refundable" switch, just that tips are no longer specially excluded from the exemptions everything else already gets. **Standing exception, unchanged by this update:** Ground D/D.1 (banned creator) still refunds the active subscription only — tips/messages stay excluded there. (On the $1000 ticket example: the $500 "video access" is PPV-style and in scope under Ground B; the $50 + $450 tips/gifts are evaluated the same way — if the creator's behaviour around them was bad-faith, that's Ground B or J, not a special tip exemption.)

**Ground K — creator-side enforcement (INTERNAL, agent-only, 2026-09-12).** None of this is ever visible to the fan: the fan reply is the "AI Refund Claim" macro and the refund itself, nothing about strikes or reviews, no hint that anything internal is happening. Alongside the refund, Vincenzo (the human agent, not the copilot) does two things:
1. **Issue a strike/warning** on the creator's account for failing to disclose AI when asked directly.
2. **Email the creator** the AI-disclosure enforcement template below — customise it per case. It is sent to the CREATOR, by email, never pasted into a fan's ticket and never generated as a customer-facing draft.

> Hi there,
>
> It has come to our attention that your interactions with fans may not clearly disclose that your content is AI-generated. We have also identified instances where responses to fan questions regarding AI usage may have been unclear, misleading, or suggested that the content was only AI-enhanced or depicted a real human when our review indicates that it is fully AI-generated.
>
> As an AI creator on Fanvue, you are required to clearly and accurately disclose the use of AI in accordance with Fanvue's platform requirements and any applicable legal obligations. This requirement also applies to chats and direct communications with fans. Creators must not avoid, obscure, or provide misleading answers when fans directly ask whether a model, piece of content, or interaction is AI-generated.
>
> Please note that statements such as "AI-enhanced," "I am real," or "I only used Photoshop to enhance my media" are not appropriate where the content is, in fact, fully AI-generated. Such statements may give fans a materially inaccurate impression of what they are purchasing or who they are interacting with. Any disclosure must therefore be clear, accurate, and unambiguous.
>
> This is particularly important where payments are involved. If a fan makes a purchase based on misleading or inaccurate representations regarding the use of AI, we may need to refund the affected transaction following our review. If similar incidents continue and additional payments are accepted from fans following misleading representations, further refunds may be issued where appropriate.
>
> Due to the misleading behaviour identified in this case, a strike has been issued to your account in accordance with our moderation policy. This serves as a formal warning. Repeated violations may result in further strikes and progressively stronger enforcement action. Continued failure to meet our disclosure requirements, particularly where fans are misled before making payments, may ultimately result in account suspension or termination.
>
> We therefore ask that you immediately review your bio, content descriptions, messaging practices, and direct interactions with fans to ensure that your use of AI is disclosed transparently and consistently.
>
> Clear AI disclosure is not optional where disclosure is required by Fanvue's policies or applicable law. It is important that you comply with these requirements at all times and do not make statements that could mislead fans regarding the nature or origin of your content.
>
> Thank you for your prompt attention to this matter and for helping us maintain transparency and trust across the Fanvue community.
>
> Kind regards,
> Fanvue Support

**Tip refund requests — no fixed template:** don't reach for a canned "tips are non-refundable" reply. Walk Q2 like any other refund request. If it lands on Ground A (most will) say so plainly in the same reply — still worth mentioning PPV as the safer, delivery-linked way to pay for specific content next time. If a ground does apply, refund the tip the same way you would a PPV payment.

**How to communicate the outcome (customer-facing posture)** — added 2026-08-22 after an app draft answered a plain buyer's-remorse request with "I'll review your refund request and provide an update here once the review is complete":
- **When it lands on a NO REFUND leaf, say so in that reply.** Don't answer with "I'll review this and update you" — if no exemption ground is evidenced there is nothing to review, and deferring leaves the fan waiting on a reversal that's never coming.
- **Never list, hint at, or invite the exemption grounds.** Don't tell a fan what *would* qualify, and never fish with "was there a problem with the content?". Naming the exits coaches them into manufacturing a qualifying story and turns a closed case into a fabricated dispute.
- **The burden starts with the fan.** Only shift into an INVESTIGATE leaf once they've *already, unprompted* described a specific problem matching a ground **and** backed it with something concrete. "Please make an exception", gratitude, and repeating the ask are not evidence.
- **Don't request transaction details you don't need.** If the answer is no regardless of amount/date/creator, asking for them is stalling dressed as diligence.
- **Handle the cancellation half properly** — it *is* actionable: Settings > Payments & Subscriptions > Manage My Subscriptions > Unsubscribe stops future renewals, and be clear that cancelling doesn't reverse a charge already taken.

**"I was scammed by the site" on a subscription you can already name (added 2026-09-12)** — after a queued draft asked a fan for their card's BIN and last 4 digits to "verify" two subscriptions the thread had already identified:
- **An angry word doesn't make a charge unidentified.** The BIN + last-4 lookup is for a payment nobody can yet account for. "I was scammed", "this site is a scam", "I never agreed to this", "I'll call my bank" about their *own* subscription, renewal or converted free trial is **Ground A**, not a fraud investigation. Don't ask for card digits, dates or screenshots, and don't promise to verify anything.
- **Give the whole answer on the first reply.** This is the one refund case where a two-line answer is wrong: the fan doesn't know how the billing works, so explain it — free trials require payment details and convert automatically unless cancelled before the trial ends (recommend cancelling **at least 24 hours** before the renewal date); once a renewal is processed the payment is non-refundable; a subscription buys **access to the content available at the time of purchase**, not a guarantee of future posts or ongoing activity, so a creator who's quiet or has limited content isn't a refund ground. Then the cancellation path and the direct link: <https://www.fanvue.com/settings/payments/subscriptions>.
- Explaining the mechanism isn't conceding it — it's what turns a refusal into something the fan can accept. It never becomes an apology for the charge, a hint that an exception exists, or an offer to look into it. Later messages on the same demand get the short firm restatement, not the full explanation again.

**Refund mechanics (any refund leaf):** fadmin → Finance > Payments, filter status PAID + created within the last 90 days, search the fan handle, tick the rows → Refund / Ban / Refund & Ban. **Always leave admin notes on BOTH the creator and fan accounts.** The refund itself (money) is a manual human action in fadmin — the copilot only drafts the investigate / evidence-request reply, never the money movement. **Ground C (fraud) and Ground J (scam/emotional blackmail) are the two grounds that need another team's explicit sign-off (Fraud Issues / Moderation) before you touch the refund button** — every other leaf, verifying in fadmin yourself is enough.
...
- **Aim for unanswerable, not short.** The goal is a reply the fan has nothing left to push back on, not a low word count. A confirmation of something already said IS just a sentence or two — but a policy refusal, a billing dispute, or anything the fan doesn't understand yet needs enough explanation that they can't reasonably come back with the same question reworded. A thorough, airtight explanation that ends the back-and-forth is doing its job better than a terse answer that invites three more messages — don't trim it down just to look disciplined.
- **What actually has to go is padding, not length.** Cut caveats nobody needs, checks nobody asked for, hedges that walk back the answer, and anything already said — regardless of how long or short the draft already is. Greeting (if opening) → the actual answer, as long as it needs to be → next step.

### Every draft needs an opening, a middle and a close (2026-09-12 refresher)
A draft that is factually right but shapeless still fails. Check all three before handing it over:
1. **Opening** — the greeting if this is Vincenzo's first message in the thread; otherwise skip straight to the substance. **On bad news** (refusal, refund declined, payout blocked, warning, restriction, ban) one short acknowledgement sentence comes first — "I know this isn't the answer you were hoping for". One sentence, never an apology for a correct decision, and never an exclamation mark on the bad-news line.
2. **Middle** — what happened or what's happening: the actual reason or mechanism in plain words. Every fact carries its consequence with it ("no earnings were generated from it" means nothing on its own — say what it means for their balance). On compliance/moderation decisions, say what triggered it, what it means for the account, and what gets the account back. Ask a question only if you genuinely need the answer and the thread doesn't already have it — never re-ask what they or another agent already covered.
