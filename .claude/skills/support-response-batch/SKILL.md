...
- **One exception to "keep it tight": the first time you deliver a policy or billing outcome.** A refusal the fan doesn't understand comes back as three more messages. On that first reply, the mechanism that produced the charge, why the policy works that way, and what they can do now all belong in it — that's substance, not a wall of text. Only after it's been explained once does the same demand get the short, firm restatement.
