...
> Vendored from https://github.com/jalaalrd/anti-ai-slop-writing (2026-09-12), unmodified, for
> Claude Code's own writing in this repo — commit messages, PR/vault docs, Slack drafts, memory
> notes. It's separate from `ANTI_AI_SLOP_RULES` in `lib/draft-ai.ts`, the customer-facing subset
> baked into the actual support-reply system prompt; see
> [[docs/vault/AI Pipeline/System Prompt Architecture.md]].
