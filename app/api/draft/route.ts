...
export async function POST(req: NextRequest) {
  ...
  if (mode === "improve") {
    systemPrompt = buildImproveSystemPrompt(agentName, toneInstruction)
    ...
    systemPrompt =
      snippets.length > 0
        ? buildNotionAwareSystemPrompt(playbook, responseTemplates, agentName, articles, snippets, hasAgentReplied, false, toneInstruction)
